...
### Here, we also apply the chain rule. The derivative of $\color{DeepSkyBlue} {  e^u}$ is $\color{DeepSkyBlue} { e^u}$, and the derivative of $\color{blue} {( 3x )}$ is $\color{blue} {3}$.
